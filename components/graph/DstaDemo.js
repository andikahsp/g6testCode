...
const DstaDemo = () => {
    ...
    const data = {
      ...
      type: 'image',
      size: 36,
      img:'https://cdn3.iconfinder.com/data/icons/communication-flat/2048/54_-_Network_Switch-1024.png',
      label: 'Router',
      children: [
        {
          id: 'c1',
          ...
          children: [
                {
                  ...
                  type: 'image',
                  size: 36,
                  img:'https://cdn0.iconfinder.com/data/icons/telecommunication-1/50/18-512.png',
                  label: 'Logs Server',
                }, {
                  id: 'Switch-89s',
                  type: 'image',
        ...
        },
        {
          ...
          type: 'image',
          size: 36,
          img:'https://cdn0.iconfinder.com/data/icons/computer-network-26/512/firewall-protection-network-analog-security-512.png',
          label: 'cisco-firewall-213',
          children: [
            {
              id: 'c3-2',
              type: 'image',
              size: 36,
              img:'https://cdn3.iconfinder.com/data/icons/communication-flat/2048/54_-_Network_Switch-1024.png',
              label: 'cisco switch-221',
              children: [
                {
                  id: 'c3-2-1',
                  type: 'image',
                  size: 36,
                  img:'https://cdn1.iconfinder.com/data/icons/devices-66/136/ibm_legacy_pc-1024.png',
